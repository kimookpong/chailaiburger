...
class BannerList extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\query\BannerListQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\BannerListQuery(get_called_class());
    }
    ...
    public function save($runValidation = true, $attributeNames = null)
    {
        ...
        if ($this->imagePath) {
            $this->images = '/banners/' . Yii::$app->security->generateRandomString(8) . '.jpg';
        }
    ...
    {
        return $this->hasOne(BannerCat::className(), ['id' => 'cid']);
    }

    public function getCatagoryList()
    {
        return BannerCat::find()->all();
    }
