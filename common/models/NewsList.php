...
class NewsList extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\query\NewsListQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\NewsListQuery(get_called_class());
    }
    ...
    public function save($runValidation = true, $attributeNames = null)
    {
        ...
        if ($this->imagePath) {
            $this->images = '/news/' . Yii::$app->security->generateRandomString(8) . '.jpg';
        }
    ...
    {
        return $this->hasOne(NewsCat::className(), ['id' => 'cid']);
    }

    public function getCatagoryList()
    {
        return NewsCat::find()->all();
    }
